        ...
        <div className="min-h-screen flex flex-col items-center bg-black">
            <main className="w-full max-w-6xl p-8">
                <div className="text-center mt-16 mb-16">
                    <h1 className="text-4xl font-bold text-white">Stéphen Chevalier - Web Developer</h1>
                </div>

                <div className={`flex ${selectedSection ? 'flex-col md:flex-row' : 'flex-col items-center'} gap-8 items-start`}>
                    <div className={`grid ${selectedSection ? 'grid-cols-1 md:grid-cols-1' : 'grid-cols-1 md:grid-cols-4'} gap-8 w-full md:w-${selectedSection ? '1/4' : 'full'} transition-all duration-300`}>
                        <div
                    ...
                    {selectedSection && (
                        <div className="flex-grow w-full md:w-3/4 bg-white p-6 rounded-lg border border-gray-300">
                            {selectedSection === 'Qui suis-je ?' && (
                                <div className="flex flex-col md:flex-row items-center md:items-start">
                                    ...
                                    <div className="text-black">
                                        ...
                                        <br/>
                                        <p>Développeur web passionné par la création de
                                            solutions innovantes, mon objectif est de donner vie à des applications
                                            web/mobiles performantes et intuitives qui répondent à vos rêves les plus
                                            fous !</p>
                                        <br/>
                                        <br/>
                                        <p>Blablabla</p>
                                ...
                                <div>
                                    <div className="grid grid-cols-1 gap-4">
                                        <div className="bg-gray-100 p-4 rounded-lg">
                                            ...
                                            <p className="text-black">Blablabla <a
                                                href="/projets/projet-1" className="text-blue-500 underline">Lire
                                                plus</a></p>
                                        </div>
                                        <div className="bg-gray-100 p-4 rounded-lg">
                                            <h3 className="text-xl font-semibold mb-2 text-black">BornToTravel -</h3>
                                            <p className="text-black">BornToTravel <a href="/projets/projet-2"
                                                                                      className="text-blue-500 underline">Lire
                                                plus</a></p>
                                        </div>
                                        <div className="bg-gray-100 p-4 rounded-lg">
                                            <h3 className="text-xl font-semibold mb-2 text-black">StockIO -</h3>
                                            <p className="text-black">Blablabla <a href="/projets/projet-2"
                                                                                   className="text-blue-500 underline">Lire
                                                plus</a></p>
                                        </div>
                                    </div>
